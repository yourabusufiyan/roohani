<?php
/**
 * This is Index Template for every page Callback
 *
 * @package Roohani
 * @since Roohani 1.0
 */
      ...
      <div class="row">
        <div class="col-md-7 col-md-offset-left-1 col-sm-offset-left-1">
          ...
          <div class="shadow-sm  bg-light rounded">
            <article id="<?php the_ID(); ?>" <?php post_class(); ?> >
              <section class="index-excerpt">
                 ...
                 <div class="post-thumbnail hideme " id="box">
                 ...
                 <div class="post-header">
                      <?php
                        ...
                        */
                        ...
                        <p><span class="post-header-meta"><i class="fas fa-clock padr-h"></i><?php the_date(get_option('date_format')); ?><?php esc_html_e(' at ', 'roohani')?><?php the_time(get_option('time_format')); ?></span>
          ...
          <div class="page-pagination">
            ...
            'prev_text'          => '<i class="fas fa-less-than"></i>',
            'next_text'          => '<i class="fas fa-greater-than"></i>',
            );
